...
Tags: Facebook, recommendations, plugin, widget, bumpin, social network

Requires at least: 2.0.2
Tested up to: 3.1.2
Install Facebook Recommendations widget for your wordpress blog.
== Description ==
The Facebook Recommend application gives visitors suggestions on what topics to view based on the activity on facebook about your website. If the visitor is logged into Facebook, the application shows the personalized recommendations by giving preference and highlighting pages her friends have interacted with. 
...
Follow the procedure to install Facebook Recommendations plugin for you blog/site.

1. Download facebook-recommend.zip
2. Unzip facebook-recommend.zip and upload `BumpIn_Facebook_Recommend.php` to the `/wp-content/plugins/` directory
3. Activate the plugin through the 'Plugins' menu in WordPress
4. Drag Drop the 'Facebook Recommend' widget to your sidebar according to your need.(goto *Presentation-> widgets*)
